...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$n,depthTest:!1,depthWrite:!1})}function tl(){return new xi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:$n,depthTest:!1,depthWrite:!1})}function nl(){return new xi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ho(),fragmentShader:`
...
`].filter(gs).join(`
`)),a=Po(a),a=ul(a,t),a=dl(a,t),o=Po(o),o=ul(o,t),o=dl(o,t),a=fl(a),o=fl(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(v=`#version 300 es
